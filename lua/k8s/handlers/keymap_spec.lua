...
describe("keymap", function()
  ...
  describe("is_action_allowed", function()
    ...
    it("should return true for allowed actions in describe view", function()
      ...
      assert.is_true(keymap.is_action_allowed("help"))
      -- logs, exec, delete are not allowed in describe view (readonly)
      assert.is_false(keymap.is_action_allowed("logs"))
      assert.is_false(keymap.is_action_allowed("exec"))
      assert.is_false(keymap.is_action_allowed("delete"))
    end)
